...
The comparison against actual market behavior, depicted in the figure below, contrasts the benchmark model results. The dot represents each metric's mean value (from its intra-rater five replicates), and the whiskers length reflect the standard error. 
